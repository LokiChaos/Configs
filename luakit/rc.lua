...
follow.label_maker = s.sort(s.reverse(s.charset("ghfjtybndksla")))
...
-- RequestPolicy Plugin
require "plugins.policy"

-- NoScript Widget Plugin
require "plugins.nscript_widget"

-- Private Browsing Plugin
require "plugins.private_browsing"

-- User Agent Contol Plugin
require "plugins.useragent"

-- Adds a menu to change tabs
require "plugins.tabmenu"

-- Add Multiple Session Support
require "plugins.multisession"
